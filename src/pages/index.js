...
import { LayoutFive, LayoutOne } from "@/layouts";
                ...
                <Tab.Container defaultActiveKey="first">
                  <div className="ltn__tab-menu ltn__tab-menu-3 text-center">
                    <Nav className="nav justify-content-center">
                      <Nav.Link eventKey="first">Grounds</Nav.Link>
                      <Nav.Link eventKey="second">Club</Nav.Link>
                      <Nav.Link eventKey="third">Shopping Mall</Nav.Link>
                      <Nav.Link eventKey="fourth">Parks</Nav.Link>
                      <Nav.Link eventKey="five"> School</Nav.Link>
                    </Nav>
                  </div>
                  <Tab.Content>
                    <Tab.Pane eventKey="first">
                      <div className="ltn__apartments-tab-content-inner">
                        <Row>
                          <Col xs={12} lg={6}>
                            <div className="apartments-plan-info ltn__secondary-bg text-color-white" style={{height: "500px"}}>
                              <h2>Grounds</h2>
                              <p>
                          ...
                          <Col xs={12} lg={6}>
                            <div className="apartments-plan-img">
                              <img src="./img/facilities/ground.jpg" alt="#" width="500px" height="500px" />
                            </div>
                          </Col>
                        </Row>
                      </div>
                    ...
                    <Tab.Pane eventKey="second">
                      <div className="ltn__product-tab-content-inner">
                        <Row>
                          ...
                          <Col xs={12} lg={6}>
                            <div className="apartments-plan-img">
                              <img src="./img/facilities/club.jpg" alt="#" width="500px" height="500px" />
                            </div>
                          </Col>
                        </Row>
                      </div>
                    ...
                    <Tab.Pane eventKey="third">
                      <div className="ltn__product-tab-content-inner">
                        <Row>
                          ...
                          <Col xs={12} lg={6}>
                            <div className="apartments-plan-img">
                              <img src="./img/facilities/mall.jpg" alt="#" width="500px" height="500px" />
                            </div>
                          </Col>
                        </Row>
                      </div>
                    ...
                    <Tab.Pane eventKey="fourth">
                      <div className="ltn__product-tab-content-inner">
                        <Row>
                          ...
                          <Col xs={12} lg={6}>
                            <div className="apartments-plan-img">
                              <img src="./img/facilities/park.jpg" alt="#" width="500px" height="500px" />
                            </div>
                          </Col>
                        </Row>
                      </div>
                    ...
                    <Tab.Pane eventKey="five">
                      <div className="ltn__product-tab-content-inner">
                        <Row>
                          ...
                          <Col xs={12} lg={6}>
                            <div className="apartments-plan-img">
                              <img src="./img/facilities/school.jpg" alt="#" width="500px" height="500px" />
                            </div>
                          </Col>
                        </Row>
                      </div>
